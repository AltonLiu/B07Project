...
public class DisplayJoinedActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_display_joined);
        ...
        for(Event e: customerObject.getJoined()){
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent is = new Intent(DisplayJoinedActivity.this, DisplayEventActivity.class);
                    is.putExtra("event", e);
                    startActivity(is);}
            });
            ln.addView(button);
